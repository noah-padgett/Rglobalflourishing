...
<!--  ggsave( -->
<!--    filename = here::here(res.dir, "fig",paste0("figure_S",fig.num,"_", outcome,"_regressed_on_", focal.predictor,".pdf")),  -->
<!--    plot = p, height = 6, width = 10, units = "in" -->
<!--   ) -->
<!--   ggsave( -->
<!--    filename = here::here(res.dir, "fig",paste0("figure_S",fig.num,"_", outcome,"_regressed_on_", focal.predictor,".png")),  -->
...
knitr::include_graphics(here::here(res.dir, "fig", paste0("figure_S",fig.num0,"_", outcome,"_regressed_on_", focal.predictor,".pdf")))
